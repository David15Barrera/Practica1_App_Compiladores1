...
/* Saltos de Linea */
    ...
    0.(0)+.{decimal}  {System.out.println("Error: " + yytext()); tabla.agregarError(yytext(), yyline, yycolumn, "Lexico", "Enteros no iician en cero"); return new Symbol(sym.ERROR, yyline+1, yycolumn+1, yytext());}
    0.(0)+.{entero} {System.out.println("Error: " + yytext()); tabla.agregarError(yytext(), yyline, yycolumn, "Lexico", "Enteros no inician en cero"); return new Symbol(sym.ERROR, yyline+1, yycolumn+1, yytext());}
    
 

    [^]                 {tabla.agregarError(yytext(), yyline+1, yycolumn+1, "Lexico", "Dato no conocido"); return new Symbol(sym.ERROR, yyline+1,yycolumn+1, yytext());}